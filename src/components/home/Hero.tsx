  ...
  return (
    <div className="relative min-h-screen flex items-start justify-center overflow-hidden pt-48 px-4 pb-4 lg:items-center lg:pt-0 lg:pb-0">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4">
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-28 items-center">
          <AnimatedElement delay={0.2} className="space-y-6">
            <div className="space-y-8">
              ...
              <div className="grid gap-6">
                <Button
                  variant="ghost"
                  className="group justify-start text-left h-auto text-gray-200 hover:text-white hover:bg-white/5 transition-all duration-300"
                  asChild
                >
                  <Link href="#about">
